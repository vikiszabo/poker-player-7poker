...
public class Player {
    ...
    static final String VERSION = "TryCatch10";
    ...
    public static int betRequest(JsonElement request) {
        try {
            ...
            if (rank1.equals("A") || rank2.equals("A") || rank1.equals("K") || rank2.equals("K") || rank1.equals("Q") || rank2.equals("Q") || rank1.equals(rank2)) return 100;
